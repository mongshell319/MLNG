    ...
    <div className="relative flex min-h-[calc(100svh-108px)] flex-col">
      ...
      >
        ...
        <div className="absolute inset-0 z-[5]">
          ...
          <div
            className="absolute left-1/2 top-[4%] w-[min(560px,88%)] -translate-x-1/2 rounded-[20px] px-5 py-4"
            style={{ background: '#F3E3CC', border: '1.5px solid #C96B4A' }}
          >
...
function Hut({ tint, deep }: { tint: string; deep: string }) {
  return (
    <svg width={132} height={96} viewBox="0 0 132 96" aria-hidden>
